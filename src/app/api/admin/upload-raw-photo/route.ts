...
/**
 * POST /api/admin/upload-raw-photo
 * Upload a raw competition photo to Supabase Storage
 */
export async function POST(request: NextRequest) {
  try {
    console.log('🏈 POST request to upload raw photo')
    ...
    console.log('⏳ Uploading to competition-raw...')
    ...
    return NextResponse.json({
      success: true,
      filename: filename,
      message: 'Raw photo uploaded successfully'
    })
